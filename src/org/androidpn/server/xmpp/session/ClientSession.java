...
public class ClientSession extends Session {
     ...
     * 
     * @return the username
     * @throws ApnUserNotFoundException if a user has not authenticated yet
     */
    public String getUsername() throws ApnUserNotFoundException {
        if (authToken == null) {
            throw new ApnUserNotFoundException();
        }
    ...
    public void setAuthToken(AuthToken authToken, String resource) {
        setAddress(new JID(authToken.getClientId(), getServerName(), resource));
        this.authToken = authToken;
