...
<tr id="trUsername" style="display:none;">
	<td>ClientId:</td>
	<td><input type="text" id="clientId" name="clientId" value="" style="width:380px;" /></td>
</tr>
<tr>
	<td>Title:</td>
	<td><input type="text" id="title" name="title" value="微校通知" style="width:380px;" /></td>
</tr>
<tr>
	<td>Message:</td>
	<td><textarea id="message" name="message" style="width:380px; height:80px;" >大帅比你好！！！</textarea></td>
</tr>
<%--
<tr>
	<td>Ticker:</td>
